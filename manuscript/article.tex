...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ss\_sim\_data }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\FunctionTok{here}\NormalTok{(}\StringTok{"simulations/sim data/ss\_res\_3.RDS"}\NormalTok{))}

\NormalTok{ss\_sim\_data }\OtherTok{\textless{}{-}}\NormalTok{ ss\_sim\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(CB\_var\_gmax\_s, CB\_var\_h\_s,}
\NormalTok{           SB\_var\_gmax\_s, SB\_var\_h\_s,}
\NormalTok{           PB\_var\_gmax\_s, PB\_var\_h\_s) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{do}\NormalTok{(}\AttributeTok{stability\_measures =} \FunctionTok{get\_stability\_measures}\NormalTok{(.}\SpecialCharTok{$}\NormalTok{ss\_res[[}\DecValTok{1}\NormalTok{]]))}
\NormalTok{results }\OtherTok{\textless{}{-}} \FunctionTok{unnest}\NormalTok{(ss\_sim\_data, }\AttributeTok{cols =} \FunctionTok{c}\NormalTok{(stability\_measures))}

\NormalTok{results }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(Species }\SpecialCharTok{==} \StringTok{"O"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ CB\_var\_gmax\_s, }\AttributeTok{y =}\NormalTok{ hyst\_range)) }\SpecialCharTok{+}
