...
```{r ss_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("CBSBPB var"), echo=FALSE}
...
```{r CB_var1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
CB_data <- readRDS(here("simulations/sim data/ss_res_grad_CB_var.RDS"))
...
```{r CB_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
...
```{r SB_var1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
SB_data <- readRDS(here("simulations/sim data/ss_res_grad_SB_var.RDS"))
...
```{r SB_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
p_overlay <- plot_ss_result2(CB_data[result_index1,]$ss_res[[1]],
...
```{r PB_var1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
PB_data <- readRDS(here("simulations/sim data/ss_res_grad_PB_var.RDS"))
...
```{r PB_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
p_overlay <- plot_ss_result2(CB_data[result_index1,]$ss_res[[1]],
...
```{r SBPB_var1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
SBPB_data <- readRDS(here("simulations/sim data/ss_res_grad_SBPB_var.RDS"))
...
```{r SBPB_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
p_overlay <- plot_ss_result2(CB_data[result_index1,]$ss_res[[1]],
