...
* Variation in amount of among strain variation, no variation in number of strains, no variation in strength or shape of the of any tradeoff.
...
```{r ss_novar, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("No diversity"), echo=FALSE}
CBSBPB_data <- readRDS(here("simulations/expt1/data/ss_res_grad_CBSBPB_var.RDS"))
result_index1 <- 1
...
```{r ss_var, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in all functional groups"), echo=FALSE}
result_index2 <- 20
...
```{r ss_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in none (solid) and all functional groups."), echo=FALSE}
...
```{r CB_var1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in CB functional group."), echo=FALSE}
CB_data <- readRDS(here("simulations/expt1/data/ss_res_grad_CB_var.RDS"))
p3  <- plot_ss_result1(CB_data,
                result_index = result_index2,
                filename_prefix = NULL,
                save_image_file = FALSE)
p3
...
```{r CB_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in none (solid) and CB functional groups."), echo=FALSE}
p_overlay <- plot_ss_result2(CB_data[result_index1,]$ss_res[[1]],
                             CB_data[result_index2,]$ss_res[[1]],
                             xlims = c(-7, -1))
p_overlay
```
...
## Figure: SB Stable states with variation and tradeoff

```{r SB_var1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in SB functional group."), echo=FALSE}
SB_data <- readRDS(here("simulations/expt1/data/ss_res_grad_SB_var.RDS"))
p4  <- plot_ss_result1(SB_data,
                result_index = result_index2,
                filename_prefix = NULL,
                save_image_file = FALSE)
p4
...
```{r SB_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in none (solid) and SB functional group."), echo=FALSE}
p_overlay <- plot_ss_result2(CB_data[result_index1,]$ss_res[[1]],
                             SB_data[result_index2,]$ss_res[[1]],
                             xlims = c(-7, -1))
...
## Figure: PB Stable states with variation and tradeoff

```{r PB_var1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in PB functional group."), echo=FALSE}
PB_data <- readRDS(here("simulations/expt1/data/ss_res_grad_PB_var.RDS"))
p5  <- plot_ss_result1(PB_data,
                result_index = result_index2,
                filename_prefix = NULL,
                save_image_file = FALSE)
p5
...
```{r PB_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in none (solid) and PB functional group."), echo=FALSE}
p_overlay <- plot_ss_result2(CB_data[result_index1,]$ss_res[[1]],
                             PB_data[result_index2,]$ss_res[[1]],
                             xlims = c(-7, -1))
...
```{r SBPB_var1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in SB and PB functional groups."), echo=FALSE}
SBPB_data <- readRDS(here("simulations/expt1/data/ss_res_grad_SBPB_var.RDS"))
p6  <- plot_ss_result1(SBPB_data,
                result_index = result_index2,
                filename_prefix = NULL,
                save_image_file = FALSE)
p6
...
```{r SBPB_var2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Diversity in none (solid) and SB and PB functional groups."), echo=FALSE}
p_overlay <- plot_ss_result2(CB_data[result_index1,]$ss_res[[1]],
                             SBPB_data[result_index2,]$ss_res[[1]],
                             xlims = c(-7, -1))
...
```{r echo=FALSE, eval = FALSE}
#ss_sim_data <- readRDS(here("simulations/expt1/data/ss_res_3.RDS"))
...
# for(i in 1:20) {
#   print(i)
#   junk <- get_stability_measures(SB_data$ss_res[[i]])
# }
# ss_object <- SB_data$ss_res[[11]]
# 
# temp2 <- filter(temp, Species == "PB_1")
# get_hysteresis_total(log10(temp2$up+1), log10(temp2$down+1))
# down <- log10(temp2$down+1)
# up <- log10(temp2$up+1)
# 

results3 <- unnest(SB_stab_data, cols = c(stability_measures))  %>%
  mutate(var_treat = "SB",
         var_gmax = SB_var_gmax_s)

PB_stab_data <- PB_data %>%
  group_by(CB_var_gmax_s, CB_var_h_s,
           SB_var_gmax_s, SB_var_h_s,
           PB_var_gmax_s, PB_var_h_s) %>%
  do(stability_measures = get_stability_measures(.$ss_res[[1]]))
results4 <- unnest(PB_stab_data, cols = c(stability_measures))  %>%
  mutate(var_treat = "PB",
...
saveRDS(all_stab_results, here("simulations/sim data/stab_measures.RDS"))
...
all_stab_results <- readRDS(here("simulations/expt1/data/stab_measures.RDS"))
...
```{r ss_var4, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
all_stab_results %>%
  #filter(var_treat == "CB") %>%
  filter(Species == "O") %>%
...
Maybe... to be added. Need to go both ways (oxic to anoxic, and anoxic to oxic).
