...
In this section we describe how we created variability among the multiple strains within functional groups. Introducing variation among multiple strains within a functional group required a number of decisions:
...
* $Div_{h,CB}$ - amount of among strain variation in the maximum growth rate $G_{max}$ of the cyanobacteria $CB$. 
* $Div_{G_{max},SB}$ - amount of among strain variation in the maximum growth rate $G_{max}$ of the sulphate reducing bacteria $SB$. 
* $Div_{h,SB}$ - amount of among strain variation in the maximum growth rate $G_{max}$ of the sulphate reducing bacteria $SB$. 
...
* $Div_{h,PB}$ - amount of among strain variation in the maximum growth rate $G_{max}$ of the phototrophic sulphur bacteria $PB$. 
