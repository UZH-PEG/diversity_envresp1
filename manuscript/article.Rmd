...
p2  <- plot_ss_result1(tmp2$ss_res[[1]],
                tmp2$CB_var_gmax_s,
                tmp2$CB_var_h_s,
                tmp2$SB_var_gmax_s,
                tmp2$SB_var_h_s,
...
p_overlay <- plot_ss_result2(tmp1$ss_res[[1]],
                             tmp2$ss_res[[1]],
                             xlims = c(-7, -1))
...
p2  <- plot_ss_result1(tmp3$ss_res[[1]],
                tmp3$CB_var_gmax_s,
                tmp3$CB_var_h_s,
                tmp3$SB_var_gmax_s,
                tmp3$SB_var_h_s,
...
p2  <- plot_ss_result1(tmp4$ss_res[[1]],
                tmp4$CB_var_gmax_s,
                tmp4$CB_var_h_s,
                tmp4$SB_var_gmax_s,
                tmp4$SB_var_h_s,
...
results <- unnest(CBSBPB_data, cols = c(stability_measures))
