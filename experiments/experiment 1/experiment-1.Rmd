...
saveRDS(parameter, here("experiments/experiment 1/data/TEST_parameter.RDS"))
saveRDS(var_expt, here("experiments/experiment 1/data/TEST_var_expt.RDS"))
```
...
parameter <- readRDS(here("experiments/experiment 1/data/TEST_parameter.RDS"))
var_expt <- readRDS(here("experiments/experiment 1/data/TEST_var_expt.RDS"))

var_expt_res <- run_ss_var_experiment(parameter, var_expt)
...
# var_expt5 <- readRDS(here("experiments/experiment 1/data/stab_data_300000.RDS")) %>%
#   mutate(sim_length = 1000000)
...
readRDS(here("experiments/experiment 1/data/stab_data_300000.RDS")) %>%
  mutate(sim_length = 1000000) %>% 
  multidplyr::partition(cluster) %>%
  mutate(stability_measures = list(get_stability_measures(ss_res))) %>%
  collect() %>%
