...
saveRDS(var_expt_least_tolerant_SBPB, here("experiments/experiment 1/data/ss_data_1e6_x1x1_factorial_SBPB_least_tolerant.RDS"))

var_expt <- var_expt_most_tolerant_SBPB
var_expt_most_tolerant_SBPB <- run_ss_var_experiment()
saveRDS(var_expt_most_tolerant_SBPB, here("experiments/experiment 1/data/ss_data_1e6_x1x1_factorial_SBPB_most_tolerant.RDS"))
```

```{r, fig.height=7.5, fig.width=12}
var_expt_least_tolerant_SBPB <- readRDS(here("experiments/experiment 1/data/ss_data_1e6_x1x1_factorial_SBPB_least_tolerant.RDS"))
var_expt_most_tolerant_SBPB <- readRDS(here("experiments/experiment 1/data/ss_data_1e6_x1x1_factorial_SBPB_most_tolerant.RDS"))
...
plot_ss_result2(var_expt_least_tolerant_SBPB$ss_res[[1]],
                var_expt[no_diversity,]$ss_res[[1]],
                xlims = c(-7, -1))+
