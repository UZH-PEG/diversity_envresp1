...
saveRDS(var_expt_small, here("experiments/experiment 1/data/var_expt_1e6_x2x6_factorial.RDS"))
```

### for testing

```{r eval = FALSE}
var_expt_small <- var_expt[c(no_diversity, medium_diverity_varexp_row),]
saveRDS(parameter, here("experiments/experiment 1/data/parameter_1e6_x2x6_factorial.RDS"))
saveRDS(var_expt_small, here("experiments/experiment 1/data/var_expt_1e6_x2x6_factorial_small.RDS"))
run_ss_var_experiment(
  parameter = readRDS(here("experiments/experiment 1/data/parameter_1e6_x2x6_factorial.RDS")), 
  var_expt = readRDS(here("experiments/experiment 1/data/var_expt_1e6_x2x6_factorial_small.RDS"))) %>%
saveRDS(here("experiments/experiment 1/data/ss_data_1e6_x2x6_factorial_small.RDS"))
```
...
readRDS(here("experiments/experiment 1/data/ss_data_1e6_x2x6_factorial_small.RDS")) %>%
  ...
  saveRDS(here("experiments/experiment 1/data/stab_data_1e6_x2x6_factorial_small.RDS"))
```


```{r eval = FALSE}
## compare version 1 results to the current.
v1_ss_data <- readRDS(here("experiments/experiment 1/data/version1_ss_data_1e6_x2x6_factorial.RDS"))
v1_stab_data <- readRDS(here("experiments/experiment 1/data/version1_stab_data_1e6_x2x6_factorial.RDS"))

small_ss_data <- readRDS(here("experiments/experiment 1/data/ss_data_1e6_x2x6_factorial_small.RDS"))
small_stab_data <- readRDS(here("experiments/experiment 1/data/stab_data_1e6_x2x6_factorial_small.RDS"))

xxxxx <- small_stab_data %>%
  select(-data, -pars, -ss_by_a_N_result, -ss_res, -sim_length) %>%
  filter(Species == "O")
v1_stab_data %>%
  filter(CB_var_gmax_s == 0, CB_var_h_s == 0,
         SB_var_gmax_s == 0, SB_var_h_s == 0,
         PB_var_gmax_s == 0, PB_var_h_s == 0) %>%
  filter(Species == "O")
v1_stab_data %>%
  slice(9620) %>%
  filter(Species == "O")
