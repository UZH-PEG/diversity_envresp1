...
```{r figure5_prepare}
gc()
if (file.exists(here("experiments/0_ss_finding/temporal_method/data/all_stab_results_small.RDS"))) {
  all_stab_results_small <- readRDS(here("experiments/0_ss_finding/temporal_method/data/all_stab_results_small.RDS"))
  all_stab_results <- readRDS(here("experiments/0_ss_finding/temporal_method/data/all_stab_results.RDS"))
  ...
  saveRDS(
    all_stab_results_small,
    here("experiments/0_ss_finding/temporal_method/data/all_stab_results_small.RDS")
  )
  saveRDS(
    all_stab_results,
    here("experiments/0_ss_finding/temporal_method/data/all_stab_results.RDS")
  )
}
...
## test1 :: Just PB
Looking at some examples
With 3 strains SB_var_gmax_s = 0.07153598 is very different to adjacent 0.06960258 and 0.07346939
```{r test1_justPB}
