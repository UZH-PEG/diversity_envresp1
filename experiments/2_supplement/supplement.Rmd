...
all_stab <- readRDS(here("data/0_ss_finding/temporal_method/processed_data/stab_data_temporal_method_eventdef1.RDS"))
...
wait_time <- "1e+04"
ss_9s <- readRDS(here(paste0("data/0_ss_finding/temporal_method/ss_data_9strains_waittime", wait_time, "_event_definition_2.RDS")))
#stab_9s <- readRDS(here(paste0("data/0_ss_finding/temporal_method/stab_data_9strains_waittime", wait_time, "_event_definition_2.RDS")))
...
only_PB_stab <- readRDS(here("data/0_ss_finding/temporal_method/processed_data/stab_data_temporal_method.RDS")) %>%
  filter(
    num_strains == 9,
    waittime == 1e6,
    var_treat == "PB",
