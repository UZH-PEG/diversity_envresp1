...
Bush et al. (2018) used the Monod equation for growth, with multiplicative kinetics when two substrates determine growth rate:

$g_j(X, Y) = g_{max,j} (\frac{X}{K_{j,X} + X})(\frac{Y}{K_{j,Y} + Y})$

g_{max,j} is the maximum specific growth rate of strain $j$

$X$ is the concentration of substrate 1, and $Y$ is the concentration of substrate 2.

K_{j,X} and K_{j,Y} are the half-saturation constants of species $j$ on substrates $X$ and $Y$.
