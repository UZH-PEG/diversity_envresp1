...
## SB diversity effect oxic to anoxic transition
...
sim_res_novar1 <- readRDS(here("experiments/2_supplement/data/puzzle1_1.RDS"))
...
sim_res_highvar1 <- readRDS(here("experiments/2_supplement/data/puzzle1_2.RDS"))
