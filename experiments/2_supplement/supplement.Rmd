...
For most of the explored combinations and amounts of functional diversity/tolerance the tipping point positions did not differ between the diversity manipulation and the tolerance manipulation (Figure \@ref(fig:max-tol1)). However, the tipping point positions did differ between the diversity manipulation and the tolerance manipulation when diversity/tolerance in the SB group was high (i.e. in the combinations SB only, CB-SB, and CB-SB-PB). 
...
(ref:max-tol2) Relationship of ecosystem state variables and oxygen diffusivity when there is variation among nine strains of SB and the amount of variation is high. All other aspects are the same as in Figure \@ref(fig:repl-meth2). 
...
(ref:max-tol3) Relationship of ecosystem state variables and oxygen diffusivity when SB contained only the most tolerant strain, with trait values corresponding with the diversity level of the previous figure. All other aspects are the same as in Figure \@ref(fig:repl-meth2). 
...
## High diversity vs. high tolerance in CB and SB
...
(ref:max-tol5)  Stable states found with the single most tolerant CB strain and SB strain and high diversity. All other aspects are the same as in Figure \@ref(fig:repl-meth2). 
