...
# Is it really functional diversity?
...
fig_div_vs_o2diff_maxtolcomp(all_stab, which_strains,
                              which_wait_time, figure_title)
```
...
(ref:max-tol3) Stable states found with the single most tolerant SB and high diversity. All other aspects are the same as in Figure \@ref(fig:repl-meth2). 
