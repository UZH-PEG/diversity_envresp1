...
saveRDS(var_expt, here("experiments/3_strains/data/var_expt_1e6_x2x6_factorial.RDS"))
```
...
readRDS(here("experiments/3_strains/data/ss_data_1e6_x2x6_factorial_small.RDS")) %>%
  ...
  saveRDS(here("experiments/3_strains/data/stab_data_1e6_x2x6_factorial_small.RDS"))
```
