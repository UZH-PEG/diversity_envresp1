...
parameter$solver_method <- "lsoda"
sim_res_novar1 <- run_simulation(parameter)
saveRDS(sim_res_novar1, here("experiments/12_strains/data/sim_res_novar1.RDS"))
```


```{r}
sim_res_novar1 <- readRDS(here("experiments/12_strains/data/sim_res_novar1.RDS"))
...
```{r}
simulation_result <- sim_res_novar1
...
saveRDS(sim_res_highvar1, here("experiments/12_strains/data/sim_res_highvar1.RDS"))
```


```{r}
sim_res_highvar1 <- readRDS(here("experiments/12_strains/data/sim_res_highvar1.RDS"))
...
saveRDS(sim_res_novar2, here("experiments/12_strains/data/sim_res_novar2.RDS"))
```


```{r}
sim_res_novar2 <- readRDS(here("experiments/12_strains/data/sim_res_novar2.RDS"))
...
saveRDS(sim_res_highvar2, here("experiments/12_strains/data/sim_res_highvar2.RDS"))
```


```{r}
sim_res_highvar2 <- readRDS(here("experiments/12_strains/data/sim_res_highvar2.RDS"))
...
saveRDS(sim_res_novar3, here("experiments/12_strains/data/sim_res_novar3.RDS"))
```


```{r}
sim_res_novar3 <- readRDS(here("experiments/12_strains/data/sim_res_novar3.RDS"))
...
saveRDS(sim_res_highvar3, here("experiments/12_strains/data/sim_res_highvar3.RDS"))
```


```{r}
sim_res_highvar3 <- readRDS(here("experiments/12_strains/data/sim_res_highvar3.RDS"))
...
saveRDS(parameter, here("experiments/12_strains/data/parameter_1e6_x2x6_factorial.RDS"))
saveRDS(var_expt, here("experiments/12_strains/data/var_expt_1e6_x2x6_factorial.RDS"))
```
...
run_ss_var_experiment(
  parameter = readRDS(here("experiments/12_strains/data/parameter_1e6_x2x6_factorial.RDS")), 
  var_expt = readRDS(here("experiments/12_strains/data/var_expt_1e6_x2x6_factorial.RDS"))) %>%
saveRDS(here("experiments/12_strains/data/ss_data_1e6_x2x6_factorial.RDS"))
```
...
readRDS(here("experiments/12_strains/data/ss_data_1e6_x2x6_factorial_small.RDS")) %>%
  ...
  saveRDS(here("experiments/12_strains/data/stab_data_1e6_x2x6_factorial_small.RDS"))
```
...
var_expt <- readRDS(here("experiments/12_strains/data/ss_data_1e6_x2x6_factorial.RDS"))
stab_data <- readRDS(here("experiments/12_strains/data/stab_data_1e6_x2x6_factorial.RDS"))
