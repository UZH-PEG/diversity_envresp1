...
saveRDS(var_expt_smaller, here("experiments/6_strains/data/var_expt_1e6_x2x6_factorial.RDS"))
```
...
readRDS(here("experiments/6_strains/data/ss_data_1e6_x2x6_factorial.RDS")) %>%
  ...
  saveRDS(here("experiments/6_strains/data/stab_data_1e6_x2x6_factorial.RDS"))
```
