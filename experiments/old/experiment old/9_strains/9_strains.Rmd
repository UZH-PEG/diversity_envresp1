...
medium_diverity_varexp_row <- 290
...
saveRDS(sim_res_novar1, here("experiments/9_strains/data/sim_res_novar1.RDS"))
```


```{r}
sim_res_novar1 <- readRDS(here("experiments/9_strains/data/sim_res_novar1.RDS"))
...
saveRDS(sim_res_highvar1, here("experiments/9_strains/data/sim_res_highvar1.RDS"))
```


```{r}
sim_res_highvar1 <- readRDS(here("experiments/9_strains/data/sim_res_highvar1.RDS"))
...
saveRDS(sim_res_novar2, here("experiments/9_strains/data/sim_res_novar2.RDS"))
```


```{r}
sim_res_novar2 <- readRDS(here("experiments/9_strains/data/sim_res_novar2.RDS"))
...
saveRDS(sim_res_highvar2, here("experiments/9_strains/data/sim_res_highvar2.RDS"))
```


```{r}
sim_res_highvar2 <- readRDS(here("experiments/9_strains/data/sim_res_highvar2.RDS"))
...
saveRDS(sim_res_novar3, here("experiments/9_strains/data/sim_res_novar3.RDS"))
```


```{r}
sim_res_novar3 <- readRDS(here("experiments/9_strains/data/sim_res_novar3.RDS"))
...
saveRDS(sim_res_highvar3, here("experiments/9_strains/data/sim_res_highvar3.RDS"))
```


```{r}
sim_res_highvar3 <- readRDS(here("experiments/9_strains/data/sim_res_highvar3.RDS"))
...
saveRDS(parameter, here("experiments/9_strains/data/parameter_1e6_x2x6_factorial.RDS"))
saveRDS(var_expt, here("experiments/9_strains/data/var_expt_1e6_x2x6_factorial.RDS"))
```
...
run_ss_var_experiment(
  parameter = readRDS(here("experiments/9_strains/data/parameter_1e6_x2x6_factorial.RDS")), 
  var_expt = readRDS(here("experiments/9_strains/data/var_expt_1e6_x2x6_factorial.RDS"))) %>%
saveRDS(here("experiments/9_strains/data/ss_data_1e6_x2x6_factorial.RDS"))
```
...
readRDS(here("experiments/9_strains/data/ss_data_1e6_x2x6_factorial_small.RDS")) %>%
  ...
  saveRDS(here("experiments/9_strains/data/stab_data_1e6_x2x6_factorial_small.RDS"))
```
...
#stab_data <- readRDS(here("experiments/9_strains/data/stab_data_1e6_x2x6_factorial.RDS"))
#stab_data_smaller <- stab_data %>%
#  mutate(num_strains = 9) %>%
#  select(1:6, 11:25)
#saveRDS(stab_data_smaller, here("experiments/9_strains/data/small_stab_1e6_x2x6_factorial.RDS"))

#var_expt$pars

stab_data <- readRDS(here("experiments/9_strains/data/small_stab_data_1e6_x2x6_factorial.RDS"))
...
p_overlay4 <- plot_ss_result2(var_expt[no_diversity,]$ss_res[[1]],
                             var_expt[medium_diverity_varexp_row,]$ss_res[[1]],
                             xlims = c(-7, -1))
p_overlay4
...
expt_res$ssfind_result[[1]]

temporal_ss_result <- expt_res
temporal_ss_result$CB_var_gmax_s[[1]]
```


```{r eval = FALSE}
saveRDS(no_div_res, here("experiments/9_strains/data/no_div_temporal_ss.RDS"))

medium_diverity_varexp_row <- 290
medium_div_res <- get_ss_temporal_method(parameter, var_expt,
                                     medium_diverity_varexp_row,
                                     wait_time)
saveRDS(medium_div_res, here("experiments/9_strains/data/medium_div_temporal_ss.RDS"))

medium_diversity_onlyCB_varexp_row <- 281
medium_divCB_res <- get_ss_temporal_method(parameter, var_expt,
                                     medium_diversity_onlyCB_varexp_row,
                                     wait_time)
saveRDS(medium_divCB_res, here("experiments/9_strains/data/medium_divCB_temporal_ss.RDS"))

medium_diversity_onlySBPB_varexp_row <- 10
medium_divSBPB_res <- get_ss_temporal_method(parameter, var_expt,
                                     medium_diversity_onlySBPB_varexp_row,
                                     wait_time)
saveRDS(medium_divSBPB_res, here("experiments/9_strains/data/medium_divSBPB_temporal_ss.RDS"))
...
# testing ssfind_temporal method
...
parameter$minimum_abundances["PB"] <- 1
parameter$event_interval <- 100
parameter$sim_duration <- wait_time * length(p$log10a_series)
parameter$sim_sample_interval <- wait_time
...
```{r}
run_temporal_ssfind_experiment(parameter, var_expt)
```
