...
```{r}
var_expt <- create_diversity(zero = zero, unity = unity, num_div_treatment_levels = num_div_treatment_levels)
...
#saveRDS(var_expt, here("experiments/experiment 1/data/ss_data_latest.RDS"))
...
```{r}
var_expt <- readRDS(here("experiments/experiment 1/data/ss_data_latest.RDS"))

ss_exp_result <- var_expt
result_index <- 1
