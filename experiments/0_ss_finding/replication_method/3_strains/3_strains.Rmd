...
saveRDS(sim_res_novar1, here("experiments/3_strains/data/sim_res_novar1.RDS"))
```


```{r}
sim_res_novar1 <- readRDS(here("experiments/3_strains/data/sim_res_novar1.RDS"))
...
saveRDS(sim_res_highvar1, here("experiments/3_strains/data/sim_res_highvar1.RDS"))
```


```{r}
sim_res_highvar1 <- readRDS(here("experiments/3_strains/data/sim_res_highvar1.RDS"))
...
saveRDS(sim_res_novar2, here("experiments/3_strains/data/sim_res_novar2.RDS"))
```


```{r}
sim_res_novar2 <- readRDS(here("experiments/3_strains/data/sim_res_novar2.RDS"))
...
saveRDS(sim_res_highvar2, here("experiments/3_strains/data/sim_res_highvar2.RDS"))
```


```{r}
sim_res_highvar2 <- readRDS(here("experiments/3_strains/data/sim_res_highvar2.RDS"))
...
saveRDS(sim_res_novar3, here("experiments/3_strains/data/sim_res_novar3.RDS"))
```


```{r}
sim_res_novar3 <- readRDS(here("experiments/3_strains/data/sim_res_novar3.RDS"))
...
saveRDS(sim_res_highvar3, here("experiments/3_strains/data/sim_res_highvar3.RDS"))
```


```{r}
sim_res_highvar3 <- readRDS(here("experiments/3_strains/data/sim_res_highvar3.RDS"))
...
saveRDS(parameter, here("experiments/3_strains/data/parameter_1e6_x2x6_factorial.RDS"))


var_expt_9strains <- readRDS(here("experiments/9_strains/data/var_expt_1e6_x2x6_factorial.RDS")) 
unique_CBs <- unique(var_expt_9strains$CB_var_gmax_s)[c(1, 5, 10, 15, 20)]
unique_SBs <- unique(var_expt_9strains$SB_var_gmax_s)[c(1, 5, 10, 15, 20)]
var_expt_smaller <- var_expt %>%
  filter(CB_var_gmax_s %in% unique_CBs & SB_var_gmax_s %in% unique_SBs)

saveRDS(var_expt_smaller, here("experiments/3_strains/data/var_expt_1e6_x2x6_factorial.RDS"))
```
...
run_ss_var_experiment(
  parameter = readRDS(here("experiments/3_strains/data/parameter_1e6_x2x6_factorial.RDS")), 
  var_expt = readRDS(here("experiments/3_strains/data/var_expt_1e6_x2x6_factorial.RDS"))) %>%
  saveRDS(here("experiments/3_strains/data/ss_data_1e6_x2x6_factorial.RDS"))
)
```
...
readRDS(here("experiments/3_strains/data/ss_data_1e6_x2x6_factorial.RDS")) %>%
  ...
  saveRDS(here("experiments/3_strains/data/stab_data_1e6_x2x6_factorial.RDS"))
```
...
var_expt <- readRDS(here("experiments/3_strains/data/ss_data_1e6_x2x6_factorial.RDS"))
stab_data <- readRDS(here("experiments/3_strains/data/stab_data_1e6_x2x6_factorial.RDS"))
...
medium_diversity_varexp_row <- 12
...
p5  <- plot_ss_result1(var_expt,
                result_index = medium_diversity_varexp_row,
                filename_prefix = NULL,
                save_image_file = FALSE)
p5
...
p_overlay4 <- plot_ss_result2(var_expt[no_diversity,]$ss_res[[1]],
                             var_expt[medium_diversity_varexp_row,]$ss_res[[1]],
                             xlims = c(-7, -1))
p_overlay4
...
var_expt_levels_3s <- var_expt[,1:6]

## here we choose the diversity of the system
wait_time <- 100000
parameter$log10a_series <- log10(sort(unique(parameter$ss_expt$a_O)))
#parameter$log10a_series <- seq(-2.5, -2, 0.025)
parameter$log10a_series <- seq(-8, 0, length = 100)

no_diverity_varexp_row <- 1
no_div_res <- get_ss_temporal_method(parameter, var_expt,
                                     no_diverity_varexp_row,
                                     wait_time)
saveRDS(no_div_res, here("experiments/3_strains/data/no_div_temporal_ss.RDS"))

medium_diverity_varexp_row <- 18
medium_div_res <- get_ss_temporal_method(parameter, var_expt,
                                     medium_diverity_varexp_row,
                                     wait_time)
saveRDS(medium_div_res, here("experiments/3_strains/data/medium_div_temporal_ss.RDS"))

medium_diversity_onlyCB_varexp_row <- 16
medium_divCB_res <- get_ss_temporal_method(parameter, var_expt,
                                     medium_diversity_onlyCB_varexp_row,
                                     wait_time)
saveRDS(medium_divCB_res, here("experiments/3_strains/data/medium_divCB_temporal_ss.RDS"))

medium_diversity_onlySBPB_varexp_row <- 3
medium_divSBPB_res <- get_ss_temporal_method(parameter, var_expt,
                                     medium_diversity_onlySBPB_varexp_row,
                                     wait_time)
saveRDS(medium_divSBPB_res, here("experiments/3_strains/data/medium_divSBPB_temporal_ss.RDS"))

```


```{r}
no_div_res <- readRDS(here("experiments/3_strains/data/no_div_temporal_ss.RDS"))
medium_div_res <- readRDS(here("experiments/3_strains/data/medium_div_temporal_ss.RDS"))
medium_divCB_res <- readRDS(here("experiments/3_strains/data/medium_divCB_temporal_ss.RDS"))
medium_divSBPB_res <- readRDS(here("experiments/3_strains/data/medium_divSBPB_temporal_ss.RDS"))


plot_ss_result3(no_div_res)
plot_ss_result3(medium_div_res)
plot_ss_result3(medium_divCB_res)
plot_ss_result3(medium_divSBPB_res)
