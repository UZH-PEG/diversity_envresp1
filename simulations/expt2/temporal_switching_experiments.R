...
default_minimum_abundances <- rep(10000, 3)
...
var_expt <- readRDS(here("simulations/expt2/data/ss_res_grad_CBSBPB_var.RDS"))
sim_number <- 1
#default_log10a_series <- c(-2, -2, -2, -5, -5, -5, -5, -5, -5)
default_log10a_series <- c(-1, -7, -1)
...
ggsave(here("simulationsexpt2/figures/switching_comparison.pdf"), width = 5, height = 4)
...
ggsave(here("simulationsexpt2/figures/switching_lowvar.pdf"), width = 10)
...
plot_ss_result(var_expt$ss_res[[number]],
                ...
                filename_prefix = here("simulationsexpt2/figures", paste0("h-factor", h_factor)))
...
ggsave(paste0("various_stuff/workingexpt2/figures/9strain_CBvar-",
...
#                 var_expt$PB_var_gmax_s[number],
#                 var_expt$PB_var_h_s[number],
#                 filename_prefix = here("simulationsexpt2/figures/ssres_CBSBPB_var"))
# 
# var_expt %>%
#   group_by(CB_var_gmax_s, CB_var_h_s,
#            SB_var_gmax_s, SB_var_h_s,
