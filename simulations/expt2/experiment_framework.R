...
grid_num_a <- 2 ## number of a_0 values
...
saveRDS(var_expt, here("simulations/expt2/data/ss_res_grad_CBSBPB_var.RDS"))

# CBSBPB_data <- readRDS(here("simulations/expt2/data/ss_res_grad_CBSBPB_var.RDS"))
# result_index1 <- 1
...
var_expt <- run_ss_var_experiment()
saveRDS(var_expt, here("simulations/expt2/data/ss_res_grad_CB_var.RDS"))
...
PB_var_h_s <- 0 ## seq(0, -0.5, length=var_length)
var_expt <- run_ss_var_experiment()
saveRDS(var_expt, here("simulations/expt2/data/ss_res_grad_SB_var.RDS"))
...
PB_var_h_s <- seq(0, -0.5, length=var_length) #*  0.15789474
var_expt <- run_ss_var_experiment()
saveRDS(var_expt, here("simulations/expt2/data/ss_res_grad_PB_var.RDS"))
...
saveRDS(var_expt, here("simulations/expt2/data/ss_res_grad_SBPB_var.RDS"))
...
var_expt <- readRDS(here("simulations/expt2/data/ss_res_3.RDS"))
sim_number <- 1
...
#saveRDS(var_expt, here("simulations/expt2/data/ss_res_1.RDS"))
...
#   )
# ## save results to file
# #saveRDS(var_expt, here("simulations/expt2/data/ss_res_2.RDS"))
# 
# var_expt <- readRDS(here("simulations/expt2/data/ss_res_2.RDS"))
# 
# number <- 1
# plot_ss_result1(var_expt$ss_res[[number]],
#                 var_expt$CB_var_gmax_s[number],
