...
For most of the explored combinations and amounts of functional diversity/tolerance the tipping point positions and strain dynamics did not differ between the diversity manipulation and the tolerance manipulation (Figure \@ref(fig:max-tol1)). However, in some cases there were effects, which are described in the follow sections.
...
## Why only at high diversity/tolerance?
