...
## Complementarity versus sampling effect
...
For most of the explored combinations and amounts of functional diversity/tolerance the tipping point positions did not differ between the diversity manipulation and the tolerance manipulation (Figure \@ref(fig:max-tol1)). However, the tipping point positions did differ between the diversity manipulation and the tolerance manipulation when diversity/tolerance in the SB group was high (i.e. in the combinations SB only, CB-SB, and CB-SB-PB). We show below that...(TO DO: Summarize results).
