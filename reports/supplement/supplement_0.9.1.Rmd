...
In the SB-SB case, presence of only the high tolerance strain could cause the system to not display any alternate stable states (Figure \@ref(fig:max-tol5)).
...
## PB_CB
only_PB_CB_variable <- ss_9s %>%
  filter(
    abs(SB_var_gmax_s) < 0.0001
  )
only_PB_CB_variable <- only_PB_CB_variable[order(only_PB_CB_variable$PB_var_gmax_s), ]

## CB_SB
only_CB_SB_variable <- ss_9s %>%
  filter(
    abs(PB_var_gmax_s) < 0.0001
  )
only_CB_SB_variable <- only_CB_SB_variable[order(only_CB_SB_variable$PB_var_gmax_s), ]

## PB_SB
only_PB_SB_variable <- ss_9s %>%
  filter(
    abs(CB_var_gmax_s) < 0.0001
  )
only_PB_SB_variable <- only_PB_SB_variable[order(only_PB_SB_variable$PB_var_gmax_s), ]


## CB_PB_SB
only_CB_PB_SB_variable <- ss_9s
only_CB_PB_SB_variable <- only_CB_PB_SB_variable[order(only_CB_PB_SB_variable$PB_var_gmax_s), ]

```

## PB
```{r echo = FALSE,  include=TRUE, fig.height=10, fig.width=8, fig.align="center"}
fig_state_vs_o2diff_sidebyside_alternative(only_PB_variable[sim1,])
fig_state_vs_o2diff_sidebyside_alternative(only_PB_variable[sim2,])
```
...
```{r echo = FALSE,  include=TRUE, fig.height=10, fig.width=8, fig.align="center"}
sim3 <- 19
fig_state_vs_o2diff_sidebyside_alternative(only_CB_variable[sim1,])
fig_state_vs_o2diff_sidebyside_alternative(only_CB_variable[sim2,])
fig_state_vs_o2diff_sidebyside_alternative(only_CB_variable[sim3,])
```

## SB
```{r echo = FALSE,  include=TRUE, fig.height=10, fig.width=8, fig.align="center"}
fig_state_vs_o2diff_sidebyside_alternative(only_SB_variable[sim1,])
fig_state_vs_o2diff_sidebyside_alternative(only_SB_variable[sim2,])
```

## PB & CB
```{r echo = FALSE,  include=TRUE, fig.height=10, fig.width=8, fig.align="center"}
fig_state_vs_o2diff_sidebyside_alternative(only_PB_CB_variable[sim1,])
fig_state_vs_o2diff_sidebyside_alternative(only_PB_CB_variable[sim2,])
```

## CB & SB
```{r echo = FALSE,  include=TRUE,, fig.height=10, fig.width=8, fig.align="center"}
fig_state_vs_o2diff_sidebyside_alternative(only_CB_SB_variable[sim1,])
fig_state_vs_o2diff_sidebyside_alternative(only_CB_SB_variable[sim2,])
```

## PB & SB
```{r echo = FALSE,  include=TRUE, fig.height=10, fig.width=8, fig.align="center"}
fig_state_vs_o2diff_sidebyside_alternative(only_PB_SB_variable[sim1,])
fig_state_vs_o2diff_sidebyside_alternative(only_PB_SB_variable[sim2,])
```

## CB & PB & SB
```{r echo = FALSE,  include=TRUE, fig.height=10, fig.width=8, fig.align="center"}
fig_state_vs_o2diff_sidebyside_alternative(only_CB_PB_SB_variable[sim1,])
fig_state_vs_o2diff_sidebyside_alternative(only_CB_PB_SB_variable[sim2,])
```
