...
When there was medium to high variation in only the phototrophic sulfur bacteria, the dynamics of strains and substrates deviated from the standard pattern: at low oxygen diffusivity, all three groups coexisted. On the trajectory of decreasing oxygen diffusivity, cyanobacteria reappeared after their collapse (medium variation in PB, Figure xy) or never collapsed (high variation in PB, Figure xy). On the trajectory of increasing oxygen diffusivity, cyanobacteria coexisted with the two groups of sulfur bacteria at low oxygen diffusivity, collapsed at medium levels of oxygen diffusivity, and then increased to sole dominance at the tipping point to the oxic state. 


Explain pattern (Romana).

The same pattern occurred for simultaneous variation in phototrophic sulfur bacteria and cyanobacteria, albeit only on the trajectory of increasing oxygen diffusivity (Figure xy). On the trajectory of decreasing oxygen diffusivity, medium to high variation in both groups led to sole dominance of cyanobacteria over the entire gradient of oxygen diffusivity. 
...
For most of the explored combinations and amounts of functional diversity/tolerance the tipping point positions did not differ between the diversity manipulation and the tolerance manipulation (Figure \@ref(fig:max-tol1)). However, in some cases there were effects, three of which are described in the follow sections.
...
## High tolerance vs. high diversity in CB-SB

In the SB-CB case, presence of only the most tolerant strain led to coexistence of all groups at low levels of oxygen diffusivity when trait values were moderately high (Figure xy) or to absence of alternate stable states when trait values were high (Figure \@ref(fig:max-tol5)).
...
## High tolerance vs. high diversity in PB
...
## High tolerance vs. high diversity in CB-SB-PB
